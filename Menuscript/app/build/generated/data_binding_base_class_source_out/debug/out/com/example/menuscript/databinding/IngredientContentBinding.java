...
public final class IngredientContentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static IngredientContentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IngredientContentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ingredient_content, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IngredientContentBinding bind(@NonNull View rootView) {
